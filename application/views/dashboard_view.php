<?php $this->load->view('_part/D_header')?>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="<?php echo site_url('page')?>" class="logo"><b>VA-11<span>Hall-A</span></b></a>
      <!--logo end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="profile.html"><img src="<?php echo $this->session->userdata('img') ?>" class="img-circle" width="80"></a></p>
    ...
    <!--footer end-->
  <?php $this->load->view('_part/D_footer')?>